...
export class DashboardDevicesComponent implements OnInit, OnDestroy
{
    ...
    constructor(private dashboardDevicesService: DashboardDevicesService)
    {
        this.projects = this.dashboardDevicesService.projects;
        this.selectedProject = this.projects[0];
        this.widgets = this.dashboardDevicesService.widgets;
